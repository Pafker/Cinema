...
class Punkt
{
	...
	public void opis()
	{
		...
		System.out.println("Masa punktu wynosi "+getMass()+" a promien "+getPromien()+" i jej główny moment bezwładności wynosi "+moment());
		System.out.println("Odleglosc od osi obrotu to "+getOdleglosc());
		System.out.println("Moment bezwładności punktu względem nowej osi obrotu wynosi "+steiner(getOdleglosc()));
		System.out.println();
	}
